...
`01-config` (providers/prompts) · `02-state` (storage/state/DOM/$) · `03-models` (fetch model/device check) · `04-voice` (mode/voice/screen) · `05-llm` (buildRequest/streamLLM) · `06-render` (markdown/bubbles) · `07-main` (submit/sessions/init). `config.local.js` (optional) โหลดก่อน `js/*`
